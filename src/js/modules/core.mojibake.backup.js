// Auto-generated recovery bundle - 2026-03-17T20:22:34
...
function viewDoc(collection,id){
  ...
  openModal(`
    ...
    ${(doc.items||[]).map(i=>`<tr><td>${i.nombre||'â€”'}</td><td>${i.cantidad}</td><td>${fmt(i.precio)}</td><td style="font-weight:700;color:var(--accent)">${fmt(i.cantidad*i.precio)}</td></tr>`).join('')}
    </tbody></table></div>
