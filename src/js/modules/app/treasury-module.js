...
(function initTreasuryModule(global) {
  ...
  function renderTesPagosProvLegacy(ctx) {
    ...
    <div style="display:flex;gap:6px;margin-bottom:10px;flex-wrap:wrap;align-items:center">
      ...
      <button type="button" class="btn btn-secondary btn-sm" onclick="backfillSaleItemsVentaPos()" title="Herramienta técnica: crear líneas sale_items desde facturas. Usa Ventas → Consolidado para la UI final. Idempotente; no toca stock ni caja.">Backfill sale_items</button>
