...
(function initTreasuryModule(global) {
  ...
  function calcDeudaProveedor(state, provId) {
    ...
    for (let i = 0; i < moves.length; i++) {
      ...
      if (!art || !esMercCreditoTitulo(art.tituloMercancia) || !art.proveedorId) continue;
    ...
    (function () {
      ...
      fetch('http://127.0.0.1:7397/ingest/fdd15a6c-f2bb-4e50-9cda-32cc3a03f3ff', {
        ...
        body: JSON.stringify({
          ...
          runId: 'cajas-debug',
          hypothesisId: 'H3',
          location: 'treasury-module.js:renderTesCajas',
          message: 'render tes cajas',
          data: { count: cajas.length, uniqueIds: new Set(ids).size, ids, nombres: cajas.map((c) => c.nombre) },
          timestamp: Date.now()
        })
      }).catch(function () {});
    })();
