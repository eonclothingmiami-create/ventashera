            ...
            .map((p) => {
              ...
              <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:8px;margin-bottom:8px">
                ...
                <div style="border-left:3px solid rgba(251,191,36,.85);padding:8px 10px;background:rgba(251,191,36,.07);border-radius:8px">
                  ...
                  <div style="font-size:9px;color:var(--text2);margin-top:4px;line-height:1.35">Solo ventas POS/vitrina/despachos. Los <b>ajustes ±</b> del módulo afectan <b>ref.</b> y la columna ref. deuda, no este total.</div>
                </div>
              </div>
              ...
              <span title="max(0, ref. − pagos caja (&gt;0) − devoluciones). Los abonos negativos (reg. créd.) no entran aquí: la ref. ya refleja ese inventario."><b style="color:var(--yellow)">${fmt(p.saldoOperativoEstimado)}</b> <span style="color:var(--text2)">pend. est.</span></span><span style="color:var(--border)">|</span>
