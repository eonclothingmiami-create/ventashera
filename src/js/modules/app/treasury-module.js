  ...
  function renderTesPagosProv(ctx) {
    ...
    ${
      compromisosRecientes.length > 0
        ? `<div class="card"><div class="card-title">📒 ÚLTIMAS NOTAS EN LIBRO (OPCIONAL)</div><div class="table-wrap"><table><thead><tr><th>Fecha</th><th>Proveedor</th><th>Valor</th><th>Líneas</th><th>Ref.</th><th>Nota</th><th></th></tr></thead><tbody>${compromisosRecientes
            .map(
              (c) => {
