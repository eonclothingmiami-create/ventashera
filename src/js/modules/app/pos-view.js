    ...
    <div class="pos-layout">
      ...
      <div class="pos-cart">
        ...
        <div class="pos-cart-footer">
          ...
          ${posFormState.canal === 'local' ? `
          <label class="form-label" style="font-size:10px;color:var(--text2);margin-bottom:4px">🚚 Flete * (obligatorio)</label>
          <div style="display:flex;align-items:center;gap:8px;margin-bottom:10px">
            <span style="font-size:12px;color:var(--text2);white-space:nowrap">$</span>
            <input type="number" id="pos-flete-valor" class="form-control" style="padding:6px;width:140px" value="${posFormState.flete || 0}" min="0" step="any" oninput="toggleFlete()" placeholder="Costo mensajería">
          </div>` : ''}
