  ...
  function render(ctx, mountEl) {
    ...
    const goLiveBanner = sinCompras
      ...
      <div style="display:flex;flex-wrap:wrap;gap:8px">
        ...
        <button type="button" class="btn btn-secondary btn-sm" onclick="typeof __cxpGoLiveCheck==='function'?__cxpGoLiveCheck():alert('Recarga con compras8 y abre consola F12')">Diagnóstico consola</button>
      </div>
    </div>`
      : '';
    el.innerHTML = `
