...
(function initVentasCatalogoModule(global) {
  ...
  /** Texto para buscar en ítems (nombre, ref, id producto). */
  ...
  /** Resumen en tabla: cantidad + vista previa de referencias. */
  ...
  function renderVentasCatalogo(ctx) {
    ...
    <div style="display:flex;gap:10px;align-items:flex-end;flex-wrap:wrap;margin-bottom:16px;">
      <div class="search-bar" style="flex:1;min-width:200px;max-width:360px;margin:0">
        ...
        <input type="text" id="vcatalog-search" class="form-control" placeholder="Ref pedido, cliente, ref producto…" value="${esc(document.getElementById('vcatalog-search')?.value || '')}"
    ...
    <div class="card">
      ...
      <p style="font-size:12px;color:var(--text2);margin:0 0 14px;line-height:1.45">
        Con <b>pago exitoso</b> puedes usar <b>🛒 Venta POS</b> para generar la factura en el ERP, descontar stock, <code>stock_moves</code> y caja (si hay caja abierta). Las líneas se ven en Productos y en <b>Ver</b>.
      </p>
      <div class="table-wrap">
        <table>
          <thead>
            <tr>
              <th>Fecha</th><th>Referencia</th><th>Cliente</th><th>Productos</th><th>Teléfono</th><th>Correo</th><th>Total</th><th>Pasarela</th><th>Estado</th><th></th>
            </tr>
          </thead>
          <tbody>
            ${
              rows.length === 0
                ? '<tr><td colspan="10" style="text-align:center;color:var(--text2);padding:28px">' +
