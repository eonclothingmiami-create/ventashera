...
async function procesarVentaPOS() {
  ...
  // Actualizar stock en BD si hay conexión
  if(_sbConnected){
    try {
...
function printRelacionDespacho(id){
  ...
  if(!w){notify('warning','⚠️','Popup bloqueado','Permite popups para imprimir el PDF.',{duration:4000});return;}
