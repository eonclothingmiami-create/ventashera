...
${posFormState.metodo === 'efectivo' ? (() => {
          ...
          <div class="form-row" style="gap:8px; margin-bottom:10px">
            ...
            <input type="text" class="form-control" id="pos-telefono" placeholder="Teléfono (opcional)" style="padding:8px 12px" value="${posFormState.telefono}" inputmode="tel" autocomplete="tel" onpaste="event.stopPropagation()">
          </div>
