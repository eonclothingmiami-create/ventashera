 ...
 * opcional ML_LISTING_TYPE_ID. Deploy: `mercadolibre-sync-product`.
 *
 ...
 * Body: { productId, siteId }. Respuesta: { ok, dryRun?, itemId?, permalink?, mercadolibre? }.
 */
window.requestMercadoLibreSync = async function requestMercadoLibreSync(productId) {
