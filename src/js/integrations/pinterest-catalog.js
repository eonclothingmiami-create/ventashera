 ...
 *
 * Pines en lote (RSS / CSV) en Pinterest Business: feed separado, Edge Function `pinterest-product-feed`
 * (`?token=SECRET&format=rss` o `format=csv`). Ver `supabase/functions/pinterest-product-feed/index.ts`.
 */
