 ...
 *   productDataMandatory, productDataProductSpecific, productDataOptional } — objetos { FeedName: "valor" }
 *   (GetCategoryAttributes: mandatory / product_specific / optional); se fusionan en <ProductData>.
