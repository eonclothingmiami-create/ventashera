...
comment on column public.ebay_publish_config.edge_invoke_bearer is
  'Bearer anon/publishable para invocar Edge Functions desde pg_cron (clave pública del proyecto).';

update public.ebay_publish_config
